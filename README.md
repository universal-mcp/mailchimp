...
You can start using Mailchimp directly from [agentr.dev](https://agentr.dev). Visit [agentr.dev/apps](https://agentr.dev/apps) and enable Mailchimp.
...
The full list of available tools is at [./src/universal_mcp_mailchimp/README.md](./src/universal_mcp_mailchimp/README.md)
...
3. **Start the MCP Inspector**
   ...
   ```bash
   mcp dev src/universal_mcp_mailchimp/mcp.py
   ```
...
4. **Install the Application**
   ```bash
   mcp install src/universal_mcp_mailchimp/mcp.py
   ```
